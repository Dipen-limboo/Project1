			        ...
			        <div class="form">
			            <div class="left-side">
			                ...
			                <div style="display: flex; justify-content: space-between">
			                    <div>
			                        <input type="checkbox" name="color_red" value="true" <%= product.getColors().contains("red") ? "checked='checked'" : "" %>> Red <br>
			                        <input type="checkbox" name="color_blue" value="true" <%= product.getColors().contains("blue") ? "checked='checked'" : "" %>> Blue <br>
			                        <input type="checkbox" name="color_black" value="true" <%= product.getColors().contains("black") ? "checked='checked'" : "" %>> Black <br>
			                    </div>
			                    <div>
