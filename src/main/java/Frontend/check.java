...
public class check extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
        	...
        	PreparedStatement ps = conn.prepareStatement("select c.user_id, u.fname, u.lname, u.email, c.total_price from carts as c join users u on c.user_id = u.id where c.user_id = ?");
        	ps.setInt(1,  id);
