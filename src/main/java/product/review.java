...
public class review extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ps = conn.prepareStatement("select o.order_date, p.product_image, p.product_name, p.color, od.user_id from order_details as od join orders o on od.order_id=o.order_id join products p on od.product_id = p.product_id where od.user_id=?; ");
			ps.setInt(1, id);
